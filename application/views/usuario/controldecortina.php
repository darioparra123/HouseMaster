...
-------------------------------- */
            ...
            *, *:after, *:before {
            ...
            #cd-intro {
                position: relative;
                height: 100%;
background: url(http://localhost/house/images/casa2.jpg) no-repeat center center;
    ...
    <body >
        ...
        <main id="cd-main-content">
            <section id="cd-intro">
                <h1>Control de Cortinas</h1>
                <div class="row">
                    <div id="prenderluz" class="col s12 m7">
                        
                        
                        <div class="card horizontal">
                            <div id="imagen" class="card-image">
                                <img src="http://localhost/house/images/abrircortina2.gif" style="width: 100%">
                            </div>
                            <div class="card-stacked">
                                <div class="card-content">
                                    <br>
                                    <p>Para poder abrir la cortina de su casa seleccionar "Abrir"</p>
                                </div>
                                <br>
                                <form action="" method="POST">
                                <button type="submit" class="login__submit">Abrir Cortina</button>
                                </form>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="row">
                    <div id="apagarluz" class="col s12 m7">
                        
                        
                        <div class="card horizontal">
                            <div id="imagen" class="card-image">
                                <img src="http://localhost/house/images/cerrarcortina.jpg" style="width: 100%">
                            </div>
                            <div class="card-stacked">
                                <div class="card-content">
                                    <br>
                                    <p>Para poder cerrar la cortina de su casa seleccionar "Cerrar"</p>
                                </div>
                                <br>
                                <form action="" method="POST">
                                <button type="submit" class="login__submit">Cerrar Cortina</button>
                                </form>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                    <div id="configurarluz" class="col s12 m7">
                        
                        
                        <div class="card horizontal">
                            <div id="imagen" class="card-image">
                                <img src="http://localhost/house/images/calendario.jpg" style="width: 60%">
                            </div>
                            <div class="card-stacked">
                                <div class="card-content">
                                    <br>
                                    <p>Para poder configurar el tiempo de Abierto/Cerrado de la cortina seleccionar "Configurar"</p>
                                </div>
                                <br>
                                <form action="" method="POST">
                                <button type="submit" class="login__submit">Configurar Cortina</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <nav id="main-nav">
            <ul>
                ...
                <li><a href="controldecortina"><span>Control de cortinas</span></a></li>
