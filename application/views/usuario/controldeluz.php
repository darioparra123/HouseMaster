            ...
            <section id="cd-intro">
                    ...
                    <div id="prenderluz" class="col s12 m6">
                        <div class="card blue-grey darken-1">
                            <div id="imagen" class="card-image">
                                <img src="http://localhost/house/images/prenderluz.jpg" style="width: 100%">
                            </div>
                            <div class="card-stacked">
                                <div class="card-content">
                                    <br>
                                    <p>Para poder encender la luz de su casa seleccionar "Prender"</p>
                                </div>
                                <br>
                                <form action="http://localhost/house/index.php/miControlador/prenderluzarduino" method="POST">
                                    <button type="submit" class="login__submit">Prender Luz</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div id="apagarluz" class="col s12 m7">
                        ...
                        <div class="card horizontal">
                            <div id="imagen" class="card-image">
                                <img src="http://localhost/house/images/apagarluz.jpg" style="width: 100%">
                            </div>
                            <div class="card-stacked">
                                <div class="card-content">
                                    <br>
                                    <p>Para poder apagar la luz de su casa seleccionar "Apagar"</p>
                                </div>
                                <br>
                                <form action="http://localhost/house/index.php/miControlador/apagarluzarduino" method="POST">
                                    <button type="submit" class="login__submit">Apagar Luz</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div id="configurarluz" class="col s12 m7">
                        ...
                        <div class="card horizontal">
                            <div id="imagen" class="card-image">
                                <img src="http://localhost/house/images/calendario.jpg" style="width: 100%">
                            </div>
                            <div class="card-stacked">
                                <div class="card-content">
                                    <br>
                                    <p>Para poder configurar el tiempo de prendido/apagado de luz seleccionar "Configurar"</p>
                                </div>
                                <br>
                                <button type="submit" class="login__submit">
                               
                                    <a href="configurarluz">Configurar luz</a>
                                    </button>
                            </div>
                        </div>
                    </div>
